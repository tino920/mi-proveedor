...
class _EmployeesScreenState extends State<EmployeesScreen> {
                  ...
                  builder: (context, employeesProvider, child) {
                      ...
                      return Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              onPressed: () {
                                employeesProvider.clearError();
                                employeesProvider.loadEmployees();
                              },
                    ...
                    return Column(
                      children: [
                        ...
                        // Resumen de empleados con datos reales
                        Padding(
                          ...
                          child: GradientContainer(
                            ...
                            child: Row(
                              ...
                              children: [
                                _buildStatItem(
                                  'Total',
                                  '${employeesProvider.totalEmployees}',
                                  Icons.people
                                ),
                                _buildStatItem(
                                  'Activos',
                                  '${employeesProvider.activeEmployees}',
                                  Icons.person
                                ),
                                _buildStatItem(
                                  'Nuevos',
                                  '${employeesProvider.newEmployees}',
                                  Icons.person_add
                                ),
                              ],
                            ),
                        ...
                        // Lista de empleados reales
                        Expanded(
                          child: employeesProvider.employees.isEmpty
                            ? _buildEmptyState()
                            : _buildEmployeesList(employeesProvider.employees),
                        ),
                      ],
                    );
                  },
  ...
  Widget _buildEmployeesList(List<EmployeeModel> employees) {
    return RefreshIndicator(
      onRefresh: () async {
        await context.read<EmployeesProvider>().loadEmployees();
      },
